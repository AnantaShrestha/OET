                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <select required class="form-control form select2" id="service_interested"
                                        ...
                                        <option value="" selected disabled>--select any one--</option>
                                        <option value="OET Preparation Class">OET Preparation Class</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <select class="form-control form select2" id="enquiry_from"
                                        ...
                                        <option value="" selected disabled>--select any one--</option>
                                        <option value="Doctors Aboard">OET Prepration Nepal</option>
                                        <option value="Doctors Aboard">Doctors Aboard Nepal</option>
                                        <option value="Nursing Aboard Nepal">Nursing Aboard Nepal</option>
