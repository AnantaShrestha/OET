                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                 ...
                                 <div class="col-md-12">
                                      ...
                                      <input type="number" name="coursefee" class="form-control" id="coursefee" placeholder="Course Fee" value="{{$applicant->coursefee}}">
                                </div>
                                 <div class='col-md-12'>
                                  ...
                                  <select class="form-control select2" required name="modeofclass">
                                    ...
                                    <option value="Online" @if($applicant->modeofclass=='Online')  selected @endif>Online</option>
                                    <option value="Offline" @if($applicant->modeofclass=='Offline')  selected @endif>Offline</option>
                               ...
                               <div class="col-md-12">
                                  ...
                                  <input type="date" name="admissiondate" value="{{$applicant->admissiondate}}" class="form-control" required>
                              </div>
                              <div class="col-md-12">
                                   <p class="ah1" style="margin-top: 20px;">Class Start Date<span class="text-danger">*</span>
                                  </p>
                                  <input type="date" name="classstartdate"  value="{{$applicant->classstartdate}}" class="form-control" required>
                              </div>
                                <div class="col-md-12">
